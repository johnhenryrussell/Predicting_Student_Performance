...
### Next, we will look at how race affects subject specific exam scores. Let's begin by seeing how race affects parental education level.
...
### The following table gives the percentage of students whose parents did not attend college for each race group. We want to examine each group to find any relationship between parental education level and exam scores. 
