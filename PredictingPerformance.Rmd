...
test_df %>% gt() %>% gt_theme_nytimes()
```

We see that a single test preparation course has a significant effect on exam scores. In fact, taking part in a test preparation course causes an $11.7\%$ increase in mean exam score. We will examine this further when we can construct our model. 
